  ...
  return (
    <section aria-labelledby="standings-heading">
      ...
      <div className={styles.scroller} tabIndex={0} aria-label="Tabla de posiciones; deslizá horizontalmente para ver todas las columnas">
        <table>
          <thead><tr><th>Pos.</th><th>Equipo</th><th>GP</th><th>G</th><th>E</th><th>P</th><th>GF</th><th>GC</th><th>DG</th><th>Pts.</th></tr></thead>
          <tbody>
            {rows.map((row) => {
      ...
      <p className={styles.help}>GP: jugados · G: ganados · E: empatados · P: perdidos · DG: diferencia de gol</p>
    </section>
  )
}
